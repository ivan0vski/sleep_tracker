        ...
        return [
            {
                ...
                items: [
                    ...
                    { type: 'text', text: 'Заполни «во сколько лёг в кровать» — приложение уже открыто на нужной дате' }
                ]
            },
            {
            ...
            },
            {
                ...
                items: [
                    ...
                    { type: 'accent', text: 'Страница на следующий день переключилась сама — вечер относится к ней' },
                    { type: 'badge', text: 'Трекер' },
